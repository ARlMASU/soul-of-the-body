      ...
      function handleSceneTransition(event) {
        if (event.animationName === "blindFadeIn") {
          sceneBg.onload = () => {
            ...
            sceneTransitionBlind.classList.add("scene-transition-blind--hide");

            showLocationName(selectedScene.name);
          };
          sceneBg.onerror = () => console.log("Error, can't load the image.");
          ...
          console.log("blindFadeOut detected!");
          sceneTransitionBlind.classList.remove("scene-transition-blind--hide");
